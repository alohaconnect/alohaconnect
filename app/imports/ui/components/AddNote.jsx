...
class AddNote extends React.Component {
  ...
  submit(data) {
    const { note, owner, profile, createdAt } = data;
    Notes.insert({ note, owner, profile, createdAt }, this.insertCallback);
  }
  ...
  render() {
    return (
        <AutoForm ref={(ref) => { this.formRef = ref; }} schema={NoteSchema} onSubmit={this.submit}>
          <Segment>
            <TextField label="Accept Applicant" name='note'/>
            <SubmitField value='Submit'/>
            <ErrorsField/>
            <HiddenField name='owner' value={this.props.owner}/>
            <HiddenField name='profile' value={this.props.profile}/>
